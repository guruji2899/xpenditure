...
class DebtorsControllerTest < ActionController::TestCase
  ...
  test "should create debtor" do
    assert_difference('Debtor.count') do
      post :create, debtor: { amount: @debtor.amount, description: @debtor.description, name: @debtor.name }
    end
  ...
  test "should update debtor" do
    patch :update, id: @debtor, debtor: { amount: @debtor.amount, description: @debtor.description, name: @debtor.name }
    assert_redirected_to debtor_path(assigns(:debtor))
  end
